...
const Login = () => {
  const { singIn, setUsers, GoogleSignIn } = useContext(AuthContext);
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 p-6">
      <div className="max-w-4xl w-full bg-white rounded-lg shadow-lg ">
        ...
        <div className="p-10 flex flex-col max-w-3xl mx-auto">
          ...
          <div className="text-center mt-4 text-gray-500">Or login with</div>
          ...
          <div>
            <Link to={"/register"}>
              <button className=" w-full mx-auto mt-2">
                New Here? <span className="text-red-300">Register</span>
              </button>
            </Link>
          </div>
        </div>
