  ...
  return (
    <div className="flex justify-between items-center py-4">
      ...
      <div className="flex gap-3 md:gap-8">
        <button onClick={()=>{setDark(!dark)}} className="bg-button dark:bg-light-white px-2 md:px-4 py-1 md:py-2 rounded-lg font-bold hover:bg-btn-hover transition duration-150 ease-in-out cursor-pointer">
